            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{request()->routeIs('hadir') ? 'active' : ''}}">
                            <a href="{{route('hadir')}}" class='sidebar-link'>
                        ...
                        <li class="sidebar-item {{request()->routeIs('umum') ? 'active' : ''}}">
                            <a href="{{route('umum')}}" class='sidebar-link'>
                               <i class="bi bi-megaphone"></i>

                                <span>Pengumuman</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{request()->routeIs('tugas') ? 'active' : ''}}">
                            <a href="{{route('tugas')}}" class='sidebar-link'>
